 ...
 * <p>
 * The serializer interface is designed as a utility interface, giving each
 * implementation several methods for serializing to URL's, files, byte arrays
 * and more.
 * </p>
 * <p>
 * The only method to be implemented is {@link #toStream(Object, OutputStream)}
...
public interface Serializer<T> {
	...
	/**
	 * Writes the object into bytes {@code byte[]} using a
	 * {@link ByteArrayOutputStream} with set capacity.
	 *
	 * @param object   the object
	...
	/**
	 * Writes the object into bytes {@code byte[]} using a
	 * {@link ByteArrayOutputStream} with unset capacity.
	 *
	 * @param object the object
	 * @return a byte array containing the serialized object
	 * @throws IOException if an I/O error occurs
