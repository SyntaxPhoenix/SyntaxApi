...
public class KeyConstants {
    ...
    public static final Pattern KEY_PATTERN = Pattern.compile("(?<Namespace>[a-zA-Z0-9._\\-]+):(?<Key>[a-zA-Z0-9\\/._\\-]+)");
    public static final Pattern NAMED_KEY_PATTERN = Pattern
        .compile("(?<Namespace>[a-zA-Z0-9._\\-]+):(?<Key>[a-zA-Z0-9\\/._\\-]+)#(?<Name>[a-zA-Z0-9/._\\- ]+)");
